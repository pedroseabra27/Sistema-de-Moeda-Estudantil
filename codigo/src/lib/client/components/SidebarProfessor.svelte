...
<aside
	class={[
		'bg-base-100 fixed left-0 border border-r border-base-300 top-0 z-50 flex h-full w-[280px] transform flex-col shadow-xl transition-transform duration-300',
